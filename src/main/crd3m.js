...
// 贴膜模具位置，4个
let modelPosition = ["512,236","601,235","512,422","598,424"]
let mouldPosition = ["  ","188,508","295,506","403,509","512,507"]
let mouldPosition14 = ["  ","197,514","317,512","436,511","561,510"]
let mouldPosition15 = ["  ","195,510","312,509","440,514","561,508"]

let mergePosition = ["526,312","599,313","523,472","601,475"]

let topArea = ["427,168","747,402"]
...
function handler(coreldrawHandlerFilePath,model,flag,coordinateArray,filename,number,modelNumber,keep) {
    ...
    if (modelNumber == 15){
        mouldPosition = mouldPosition15;
    } else {
        mouldPosition = mouldPosition14;
    }
